---
sidebarTitle: Enrolment 2

---

<iframe width="100%" height="500" src="https://www.youtube.com/embed/NTJpmrRduww?si=BowthD_xK6MMtJSh" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Facilitators reviewed the three main learning arcs. Sense of Place asks participants to explore their communities, observe their surroundings and map local challenges and opportunities. Emergent Learning brings these insights together so teams can analyze data, share ideas and choose one problem to work on. Aligned Action is the build phase where teams use Cardano tools to create and test solutions that have real impact.

Next, the Prisma team introduced the Publishing Stack, a group of lightweight apps that make team work visible as it happens. The first tool, Docs, allows hubs and teams to share research, notes, and project updates. It supports live data, visuals and narrative content thelping teams tell their stories clearly. Carlos, the developer, demonstrated how hubs can connect their GitHub accounts and quickly deploy their own Docs sites.
...
Referenced in the [Slides](https://docs.google.com/presentation/d/1Z-nuXr0gvCbcw1tKCFYBGI9uNx1DWtLIKZlNsKrgq_c/edit?slide=id.g352c912474b_0_450#slide=id.g352c912474b_0_450):

1. [Case Study (slide 7)](https://docs.prisma.events/patterns/case-study)
2. [Apps for participation (slide 8)](https://docs.prisma.events/patterns/minimum-viable-infrastructure)
