...
Next, the Prisma team introduced the Publishing Stack, a group of lightweight apps that make team work visible as it happens. The first tool, Docs, allows hubs and teams to share research, notes, and project updates. It supports live data, visuals and narrative content to help teams tell their stories clearly. Carlos, the developer, demonstrated how hubs can connect their GitHub accounts and quickly deploy their own Docs sites.
