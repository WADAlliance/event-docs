...
At the beginning we reflected to you your own question, ["How is this hackathon different?"](/Resources/hackathonDifference) Now is time to hear from those that felt called to respond. In order to organise your contributions, we will re-open two forms in the same [enrolment app](https://cats.wada.org/enrolment) you've used before, for the two primary stakeholder groups of participants and hubs. 

1. **PARTICIPANTS: Team Enrolment:** this is the place to officially register your team. 
	1. Here we will ask you about the purpose that has called your team into action, and your self-defined problem statements. 
	2. This will also be a chance for you to confirm which hub you're related to, if that applies. 
	3. Please only submit your team once! So long as your team has submitted one form, and you are part of that team, you're done. Just select one person from your team to make the submission, or do it all together, but only submit once. Please do not duplicate your team submissions. 
	4. Each team submission will be reflected on [the globe](https://potentialise.wada.org).
2. **HUBS: Story Publication:** for hubs, this is the place to publish your [story](/evaluation/story-publishing). 
	1. This is where the "SEE STORY" button on your hub card on the globe will lead to.
	2. This is the first point of reference for evaluators to start learning about your hub's projects.
	3. Evaluators are short on time. This is the chance to hook them in, generating interest in your projects, and making visible the work happening on the ground. 
